    ...
    <div class="inner-wrap">
        <nav class="tab-bar">
            ...
            <section class="middle tab-bar-section">
                <h1 class="title"><i class="fi-social-treehouse large"></i> <a href="index.html">Tree-Foundation</a></h1>
            </section>
        </nav>
        ...
        <aside class="left-off-canvas-menu">
            <ul class="off-canvas-list">
                ...
                <li><a href="about.html"><i class="fi-megaphone"></i> ABOUT</a></li>

                <li><a href="blog.html"><i class="fi-archive"></i> LATEST</a></li>
                <li><a href="contact.html"><i class="fi-mail"></i> CONTACT</a></li>
        ...
        <div class="row">
            <div class="large-8 medium-12 columns"> <!-- Main Content Left -->
                ...
                <div class="row">
                    <div class="large-12 columns" role="content">
                        <h1><a href="#">Welcome to Tree-Foundation</a></h1>
            ...
            <div class="large-4 hide-for-medium-only columns highlight"> <!-- Sidebar right -->
